...
public class Fragment_Quantity extends BaseFragment implements ICoolor_DoctorList.IView {
    ...
    protected int getLayout() {
        return R.layout.fragment_quantity;
    }
    ...
    protected void initData() {
        ...
        if (presenter != null) {
            ((ICoolor_DoctorList.IPresenter)presenter).getDoctorList(7,3,0,1,10);
        }
    }
